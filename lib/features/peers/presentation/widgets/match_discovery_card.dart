...
class MatchDiscoveryCard extends StatelessWidget {
  ...
  const MatchDiscoveryCard({super.key, required this.match});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Column(
          children: [
            // Top portion: Peer Photo + Floating Match Percentage Pill Badge
            Expanded(
              child: Stack(
                fit: StackFit.expand,
                children: [
                  _buildPhoto(),
                  // Top-right floating Match % badge
                  Positioned(
                    top: 16,
                    right: 16,
                    child: Container(
            ...
            // Bottom portion: Info details (Name, Impact, Location, Company box)
            Container(
              color: AppColor.lightSurface,
