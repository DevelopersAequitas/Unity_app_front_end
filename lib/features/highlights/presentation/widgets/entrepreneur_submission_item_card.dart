...
class EntrepreneurSubmissionItemCard extends StatelessWidget {
  final EntrepreneurCertificationResultEntity item;
  final ValueChanged<EntrepreneurCertificationResultEntity> onViewCertificate;
  final VoidCallback onRetake;
  final bool canRetake;

  const EntrepreneurSubmissionItemCard({
    super.key,
    required this.item,
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              item.certificationTier ?? 'Entrepreneur Assessment',
              ...
              child: IconButton(
                ...
                onPressed: () {
                  CertificateShareHelper.shareCertificate(
                    ...
                    tier: item.certificationTier ?? 'Master Entrepreneur',
