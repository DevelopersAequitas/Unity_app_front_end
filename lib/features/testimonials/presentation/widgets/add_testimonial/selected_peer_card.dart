            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    'Search & select a peer to appreciate',
          ...
          Container(
            ...
            child: Row(
              children: [
                    ...
                    children: [
                      ...
                      if (peer!.city != null && peer!.city!.isNotEmpty)
                        Padding(
                          ...
                          child: Row(
                            children: [
                              const Icon(Icons.location_on_outlined, size: 11, color: AppColor.lightTextTertiary),
                      ...
                      if (peer!.designation != null && peer!.designation!.isNotEmpty)
                        Padding(
                          ...
                          child: Text(
                            [
                              peer!.designation!,
                              if (peer!.companyName != null && peer!.companyName!.isNotEmpty)
                                peer!.companyName!,
                            ].join(' at '),
                            style: AppTypography.bodySmall.copyWith(
                              fontSize: 11.5,
                ...
                IconButton(
                  icon: const Icon(Icons.close_rounded, size: 18, color: AppColor.lightTextTertiary),
                  onPressed: onClear,
