...
class P2pMeetingLeaderboardModel {
  final int rank;
  final String id;
  ...
  const P2pMeetingLeaderboardModel({
    required this.rank,
    required this.id,
  ...
  factory P2pMeetingLeaderboardModel.fromJson(
    ...
    return P2pMeetingLeaderboardModel(
  ...
  P2pMeetingLeaderboardEntity toEntity() {
    return P2pMeetingLeaderboardEntity(
      rank: rank,
      id: id,
      displayName: displayName,
      firstName: firstName,
