...
class BusinessDealLeaderboardModel {
  final int rank;
  final String id;
  ...
  const BusinessDealLeaderboardModel({
    required this.rank,
    required this.id,
  ...
  factory BusinessDealLeaderboardModel.fromJson(
    ...
    return BusinessDealLeaderboardModel(
      ...
      dealsCount: (json['deals_count'] as num?)?.toInt() ?? 0,
      totalAmount: (json['total_amount'] as num?) ?? 0,
    );
  }

  BusinessDealLeaderboardEntity toEntity() {
    return BusinessDealLeaderboardEntity(
      rank: rank,
      id: id,
      displayName: displayName,
      firstName: firstName,
