...
class P2PMeetingCreativeCard extends StatelessWidget {
  // Current User (Left)
  final String myName;
  final String? myCity;
  ...
  // Default Peers template fallback if backend URL is not passed
    ...
    return AspectRatio(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          // Proportional center points & circle diameters
          ...
          return Stack(
            ...
            children: [
              // 1. Background Template from Backend
              Positioned.fill(
                child: Image.network(
                  backgroundUrl,
                  fit: BoxFit.cover,
              ...
              // 2. Left User (Current User) Avatar
              Positioned(
              ...
              // 4. Left User Details (Name -> City -> Company -> Category)
              Positioned(
                left: cardWidth * 0.02,
              ...
              // 5. Right User Details (Name -> City -> Company -> Category)
              Positioned(
                left: cardWidth * 0.54,
                width: cardWidth * 0.44,
                top: cardHeight * 0.67,
  ...
  Widget _buildUserDetailsColumn({
    ...
    return Column(
      ...
      children: [
        // 1. Peer Name (Decreased font size + truncated)
        FittedBox(
