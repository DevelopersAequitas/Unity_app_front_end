...
import 'entrepreneur_submission_item_card.dart';

class EntrepreneurSubmissionsHistoryTab extends StatelessWidget {
  ...
  const EntrepreneurSubmissionsHistoryTab({
    super.key,
      ...
      child: NotificationListener<ScrollNotification>(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            return EntrepreneurSubmissionItemCard(
