...
class EntrepreneurUnderReviewCard extends StatelessWidget {
  final EntrepreneurCertificationResultEntity? submission;
  final VoidCallback? onViewHistory;
  final Future<void> Function()? onRefresh;

  const EntrepreneurUnderReviewCard({
    super.key,
    this.submission,
    this.onViewHistory,
    this.onRefresh,
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Your entrepreneur certification submission is currently being evaluated. You will be notified once the review is completed.',
