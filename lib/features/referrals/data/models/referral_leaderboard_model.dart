...
class ReferralLeaderboardModel {
  final int rank;
  final String id;
  ...
  const ReferralLeaderboardModel({
    required this.rank,
    required this.id,
  ...
  factory ReferralLeaderboardModel.fromJson(
    ...
    return ReferralLeaderboardModel(
      ...
      referralsCount: (json['referrals_count'] as num?)?.toInt() ??
          (json['referrals'] as num?)?.toInt() ??
          (json['count'] as num?)?.toInt() ??
          0,
    );
  }

  ReferralLeaderboardEntity toEntity() {
    return ReferralLeaderboardEntity(
      rank: rank,
      id: id,
      displayName: displayName,
      firstName: firstName,
