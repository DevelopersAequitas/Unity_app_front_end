...
class CollaborationsBottomNav extends StatelessWidget {
  final CollaborationTab activeTab;
  final ValueChanged<CollaborationTab> onTabChanged;

  const CollaborationsBottomNav({
    super.key,
            ...
            children: [
              Expanded(
                child: _buildNavItem(
                  ...
                  isSelected: activeTab == CollaborationTab.opportunities,
                  isDark: isDark,
                  onTap: () => onTabChanged(CollaborationTab.opportunities),
                ),
              ),
              ...
              Expanded(
                child: _buildNavItem(
                  ...
                  isSelected: activeTab == CollaborationTab.myHistory,
                  isDark: isDark,
                  onTap: () => onTabChanged(CollaborationTab.myHistory),
                ),
              ),
            ],
          ),
