...
class LeadershipCertificationResultModel extends LeadershipCertificationResultEntity {
  const LeadershipCertificationResultModel({
    required super.id,
  ...
  factory LeadershipCertificationResultModel.fromJson(Map<String, dynamic> json) {
    int? parsedScore;
    ...
    return LeadershipCertificationResultModel(
      ...
      certificationLevel: json['certification_level']?.toString() ??
          json['certification_tier']?.toString() ??
          json['tier']?.toString() ??
          json['level']?.toString(),
