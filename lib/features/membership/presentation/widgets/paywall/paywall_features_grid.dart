  ...
  Widget build(BuildContext context) {
    ...
    final features = [
      ...
      _FeatureItem(
        ...
        title: 'Join Circles',
        subtitle: 'Be part of exclusive circles',
      ),
      _FeatureItem(
        ...
        title: 'Access Events',
        subtitle: 'Join online & offline events',
      ),
      _FeatureItem(
        ...
        subtitle: 'Access all opportunities',
      ),
      _FeatureItem(
        ...
        title: 'Collaborate',
        subtitle: 'Find and create opportunities',
      ),
      _FeatureItem(
