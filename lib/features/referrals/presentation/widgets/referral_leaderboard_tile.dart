...
class ReferralLeaderboardTile extends StatelessWidget {
  final ReferralLeaderboardEntity item;
  const ReferralLeaderboardTile({super.key, required this.item});
  ...
  Widget build(BuildContext context) {
    ...
    final countLabel = '${item.referralsCount} ${item.referralsCount == 1 ? 'Referral' : 'Referrals'}';
