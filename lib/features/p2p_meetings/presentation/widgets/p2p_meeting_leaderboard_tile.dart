...
class P2pMeetingLeaderboardTile extends StatelessWidget {
  final P2pMeetingLeaderboardEntity item;
  const P2pMeetingLeaderboardTile({super.key, required this.item});
  ...
  Widget build(BuildContext context) {
    ...
    final countLabel = '${item.meetingsCount} ${item.meetingsCount == 1 ? 'Meeting' : 'Meetings'}';
