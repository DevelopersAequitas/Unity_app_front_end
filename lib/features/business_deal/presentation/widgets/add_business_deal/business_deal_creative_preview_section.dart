...
import '../business_deal_creative_card.dart';

class BusinessDealCreativePreviewSection extends StatelessWidget {
  ...
  const BusinessDealCreativePreviewSection({
    super.key,
      ...
      children: [
        Row(
          children: [
            ...
            Text(
              'Dynamic Business Deal Creative',
        ...
        Container(
          ...
          child: ClipRRect(
            ...
            child: RepaintBoundary(
              key: cardKey,
              child: BusinessDealCreativeCard(
                myName: myName,
                myCity: myCity,
